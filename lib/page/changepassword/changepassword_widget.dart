...
/// Create a page change password page
...
class _ChangepasswordWidgetState extends State<ChangepasswordWidget> {
  ...
  void initState() {
    ...
    _model.conNewpassTextController ??= TextEditingController();
    _model.conNewpassFocusNode ??= FocusNode();
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHANGEPASSWORD_PAGE_Icon_ns4bu3lp_ON_TAP');
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          controller:
                                              _model.conNewpassTextController,
                                          focusNode: _model.conNewpassFocusNode,
                                          autofocus: false,
                                          obscureText:
                                              !_model.conNewpassVisibility,
                                          decoration: InputDecoration(
                                          ...
                                          validator: _model
                                              .conNewpassTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ].divide(SizedBox(height: 6.0)),
                                    ),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CHANGEPASSWORD_UPDATE_PASSWORD_BTN_ON_TA');
                              if ((_model.currentTextController.text != '') &&
                                  (_model.newpassTextController.text !=
                                          '') &&
                                  (_model.conNewpassTextController.text !=
                                          '') &&
                                  (_model.newpassTextController.text ==
                                      _model.conNewpassTextController.text)) {
